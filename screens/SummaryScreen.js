  ...
  render() {
    return (
      <View style={{ flex: 1, backgroundColor: 'black' }}>
        ...
        <Text style={styles.titleP}>Present Students List</Text>
        <View style={styles.presentContainer}>
          {
            this.state.present_students.map((student, index)=>(
                <Text style={{fontSize:18, color: 'lime'}}>{student.name}</Text>
              )
            )
          }
        </View>
        <Text style={styles.titleA}>Absent Students List</Text>
